...
let s:fg0       = { "gui": "#D1B897" } " Normal text #D1B897
...
let s:slbg1     = { "gui": "#0F5966" } " Status line (file) background #0F5966
...
call s:h("vimFunction",    { "fg": s:fg0, "bg": s:bg0 })
call s:h("vimUserCmdError",{ "fg": s:fg0, "bg": s:bg0 })
...
call s:h("WildMenu",       { "bg": s:slbg0, "fg": s:fg1 })
call s:h("StatusLine",     { "fg": s:slbg1, "bg": s:slbg1 })
call s:h("StatusLineNC",   { "fg": s:bg0, "bg": s:bg0 })
call s:h("User2",          { "bg": s:slbg1, "fg": s:fg1 })
call s:h("User1",          { "bg": s:slbg1, "fg": s:fg1 })
call s:h("VertSplit",      { "bg": s:bg0 })

" Fix cursor line
hi CursorLine   cterm=NONE ctermbg=darkred ctermfg=white
hi CursorLineNr cterm=NONE ctermbg=darkred ctermfg=white

" Fix split background
